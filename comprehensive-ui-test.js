...
async function testNavigation(page) {
  ...
  try {
    ...
    const navItems = [
      ...
      { selector: 'a[href="/invoices"]', name: 'Invoices Link' },
      { selector: 'a[href="/ocr"]', name: 'OCR Link' },
      { selector: 'a[href="/reports"]', name: 'Reports Link' },
      { selector: 'a[href="/settings"]', name: 'Settings Link' }
    ];
...
async function testOCRFunctionality(page) {
  ...
  try {
    ...
    await page.goto(`${TEST_CONFIG.baseUrl}/ocr`);
...
async function testInvoiceManagement(page) {
  ...
  try {
    ...
    await page.goto(`${TEST_CONFIG.baseUrl}/invoices`);
    await page.waitForTimeout(2000);
